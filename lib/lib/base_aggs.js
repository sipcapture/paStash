...
function CountLogger(metric, reportZeros, intervalMS, callback) {
  ...
  this.subkeyData = {};
  this.metric = metric;
  this.reportZeros = reportZeros || false;
...
function config() {
  return {
    ...
    start_hook: function(callback) {
      this.create = function(metric,reporter,intervalMS,reportZeros) {
        ...
        return new CountLogger(metric, reportZeros || this.reportZeros, intervalMS || this.intervalMS, reporter || this.reporter);
      };
      callback();
    },
  };
