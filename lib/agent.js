...
LogstashAgent.prototype.configure = function(url, type, callback) {
  ...
  try {
    ...
    var module_npm = '@pastash/'+module_name;
    var module;
    try {
      module = require('./' + path.join(directory, module_name));
	    ...
	    try {
	      module = require(path.join(directory, module_name));
		    ...
		    logger.debug('no local module found',directory, module_name, e);
		    try {
		      console.log('Loading npm module...', module_npm);
		      module = requireg(module_npm);
...
exports.base_input = require('./lib/base_input');
exports.base_output = require('./lib/base_output');
exports.base_filter = require('./lib/base_filter');
exports.cache_helper = require('./lib/cache_helper');
exports.ssl_helper = require('./lib/ssl_helper');
exports.async_helper = require('./lib/async_helper');
exports.regex_helper = require('./lib/regex_helper');
